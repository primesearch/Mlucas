...
***/
	...
	__asm__ volatile (\
		...
		/* 3rd-order update of 23-bit result needs just 2 FMA, 1 MUL: */\
	...
	"prefetcht1	%c[__pfetch_dist](%%r15)\n\t"/* [base-address + data-fetch-ahead index] + p0 */\
		...
		"vmovaps		%%ymm6 ,0x0c0(%%rdi)		\n\t	vmovaps			%%ymm2 ,0x040(%%rdi)		\n\t"\
		"vmovaps		%%ymm7 ,0x0e0(%%rdi)		\n\t	vmovaps			%%ymm3 ,0x060(%%rdi)		\n\t"\
		"/* Due to array-padding scheme cannot assume add0 + p2 - p1 == add0 + p1, must subtract p1-offsets, then add p2s: */\n\t"\
		"subq	%%r9,%%rax			\n\t"\
		"subq	%%r9,%%rbx			\n\t"\
		"subq	%%r9,%%rcx			\n\t"\
		"subq	%%r9,%%rdx			\n\t"\
	...
	"/*************************************************************************************/\n\t"\
		...
		"subq	$0x300,%%rsi 		/* revert cc-ptr to base value */\n\t"\
	...
	// Remember that for AVX2-style 3-operand FMA in AT&T syntax, the result overwrites the rightmost input!
	#define SSE2_RADIX16_DIF_TWIDDLE_2(Xadd0,Xp1,Xp2,Xp3,Xp4,Xp8,Xp12,Xr1,Xcc0,Xpfetch_addr,Xpfetch_dist)\
	{\
	__asm__ volatile (\
		/*...Block 1:	*/\
		"movq	%[__add0],%%rax				\n\t"\
	...
	#define SSE2_RADIX16_DIT_TWIDDLE_1(Xadd0,Xp1,Xp2,Xp3,Xp4,Xp8,Xp12,Xr1,Xcc0,Xpfetch_addr,Xpfetch_dist)\
	{\
	__asm__ volatile (\
...
/* Swap Blocks 2,3 here to allow simple-incrementation of array ptrs (decr. not safe w.r.to array padding). */\
	...
	/*...Block 4: t7/8,15/16,23/24,31/32 in ymm0-7: */\
		...
		: [__add0] "m" (Xadd0)	/* All inputs from memory addresses here */\
		 ...
		 ,[__pfetch_addr] "m" (Xpfetch_addr)\
		 ,[__pfetch_dist] "e" (Xpfetch_dist)\
		: "cc","memory","rax","rbx","rcx","rdx","rdi","rsi","r9","r10","r14","r15","xmm0","xmm1","xmm2","xmm3","xmm4","xmm5","xmm6","xmm7","xmm8","xmm9","xmm10","xmm11","xmm12","xmm13","xmm14","xmm15"	/* Clobbered registers */\
	);\
	}
...
/* Swap Blocks 2,3 here to allow simple-incrementation of array ptrs (decr. not safe w.r.to array padding). */\
	...
	"prefetcht1	%c[__pfetch_dist](%%r15)\n\t"/* [base-address + data-fetch-ahead index] + p0 */\
		...
		"vmovaps	0x020(%%rbx),%%ymm1			\n\t		vmovaps	0x020(%%r11),%%ymm9 	\n\t"\
		"vmovaps	0x020(%%rdx),%%ymm5			\n\t		vmovaps	0x020(%%r13),%%ymm13	\n\t"\
	"prefetcht1	%c[__pfetch_dist](%%r15,%%rdi)\n\t"/* ...+p4 */\
		"vsubpd	%%ymm0,%%ymm2,%%ymm2			\n\t		vmovaps	-0x400(%%r8),%%ymm10	\n\t"\
		"vsubpd	%%ymm4,%%ymm6,%%ymm6			\n\t		vmovaps	%%ymm10,%%ymm14			\n\t"\
		"vsubpd	%%ymm1,%%ymm3,%%ymm3			\n\t		vmovaps	%%ymm10,%%ymm11			\n\t"\
		"vsubpd	%%ymm5,%%ymm7,%%ymm7			\n\t		vmovaps	%%ymm10,%%ymm15			\n\t"\
	...
	"prefetcht1	%c[__pfetch_dist](%%r15)\n\t"/* ...+p12 */\
		...
		: [__add0] "m" (Xadd0)	/* All inputs from memory addresses here */\
		 ...
		 ,[__pfetch_addr] "m" (Xpfetch_addr)\
		 ,[__pfetch_dist] "e" (Xpfetch_dist)\
		: "cc","memory","rax","rbx","rcx","rdx","rdi","rsi","r8","r10","r11","r12","r13","r14","r15","xmm0","xmm1","xmm2","xmm3","xmm4","xmm5","xmm6","xmm7","xmm8","xmm9","xmm10","xmm11","xmm12","xmm13","xmm14","xmm15"	/* Clobbered registers */\
	);\
	}
  ...
  #define USE_64BIT_ASM_STYLE	1	// My x86 timings indicate fancier versions below using ymm0-15 for the radix-16 DFT is faster.
	...
	__asm__ volatile (\
		...
		"vmulpd	0xc0(%%rsi),%%ymm4,%%ymm4	/* c12 */\n\t"\
		"vmulpd	0xc0(%%rsi),%%ymm5,%%ymm5	\n\t"\
		"vmulpd	0xe0(%%rsi),%%ymm6,%%ymm6	\n\t"\
		...
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		"vsubpd	     (%%rdi),%%ymm4,%%ymm4	\n\t"\
		"vsubpd	0x020(%%rdi),%%ymm5,%%ymm5	\n\t"\
		"vaddpd	     (%%rdi),%%ymm6,%%ymm6	\n\t"\
		"vaddpd	0x020(%%rdi),%%ymm7,%%ymm7	\n\t"\
		...
		"vmovaps	%%ymm0,0x080(%%rdi)	\n\t"\
		"vmovaps	%%ymm2,0x040(%%rdi)	\n\t"\
		"vmovaps	%%ymm1,0x0a0(%%rdi)	\n\t"\
		"vmovaps	%%ymm3,0x0e0(%%rdi)	\n\t"\
		"vaddpd	%%ymm6,%%ymm6,%%ymm6		\n\t"\
		"vaddpd	%%ymm5,%%ymm5,%%ymm5		\n\t"\
		"vaddpd	%%ymm7,%%ymm7,%%ymm7		\n\t"\
		"vaddpd	%%ymm4,%%ymm4,%%ymm4		\n\t"\
		...
		"vmovaps	%%ymm6,     (%%rdi)	\n\t"\
		"vmovaps	%%ymm5,0x0c0(%%rdi)	\n\t"\
		"vmovaps	%%ymm7,0x020(%%rdi)	\n\t"\
		"vmovaps	%%ymm4,0x060(%%rdi)	\n\t"\
		"movslq	%[__p2],%%rdi		\n\t"\
		"shlq	$3,%%rdi			\n\t"\
		"addq	%%rdi,%%rax			\n\t"\
		"addq	%%rdi,%%rbx			\n\t"\
		...
		"vaddpd	%%ymm6,%%ymm5,%%ymm5		\n\t"\
		"vsubpd	%%ymm7,%%ymm4,%%ymm4		\n\t"\
		"vmovaps	%%ymm5,0x20(%%rsi)	/* r9.im */\n\t"\
		"vmovaps	%%ymm4,    (%%rsi)	/* r9.re */\n\t"\
		"vmovaps	    (%%rbx),%%ymm4	\n\t"\
		"vmovaps	0x20(%%rbx),%%ymm5	\n\t"\
		"vmovaps	    (%%rbx),%%ymm6	\n\t"\
		"vmovaps	0x20(%%rbx),%%ymm7	\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm4,%%ymm4	/* c6, using r9 as base ptr */\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm5,%%ymm5	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm6,%%ymm6	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm7,%%ymm7	\n\t"\
		"vaddpd	%%ymm6,%%ymm5,%%ymm5		\n\t"\
		"vsubpd	%%ymm7,%%ymm4,%%ymm4		\n\t"\
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		...
		"vmovaps	    (%%rbx),%%ymm6	\n\t"\
		"vmovaps	0x20(%%rbx),%%ymm7	\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm4,%%ymm4	/* c5, using r17 as base ptr */\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm5,%%ymm5	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm6,%%ymm6	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm7,%%ymm7	\n\t"\
		"vaddpd		%%ymm6  ,%%ymm5,%%ymm5		\n\t"\
		...
		"vmovaps	    (%%rbx),%%ymm6	\n\t"\
		"vmovaps	0x20(%%rbx),%%ymm7	\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm4,%%ymm4	/* c7, using r25 as base ptr */\n\t"\
		"vmulpd	0x4e0(%%rsi),%%ymm5,%%ymm5	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm6,%%ymm6	\n\t"\
		"vmulpd	0x500(%%rsi),%%ymm7,%%ymm7	\n\t"\
		"vaddpd		%%ymm6  ,%%ymm5,%%ymm5		\n\t"\
		...
		"movq	%[__r1],%%rsi		\n\t"\
		"vmovaps	     (%%rsi),%%ymm0	\n\t"\
		"vmovaps	0x200(%%rsi),%%ymm4	\n\t"\
		"vmovaps	0x020(%%rsi),%%ymm1	\n\t"\
		"vmovaps	0x220(%%rsi),%%ymm5	\n\t"\
		"vmovaps	0x100(%%rsi),%%ymm2	\n\t"\
		"vmovaps	0x300(%%rsi),%%ymm6	\n\t"\
		"vmovaps	0x120(%%rsi),%%ymm3	\n\t"\
		"vmovaps	0x320(%%rsi),%%ymm7	\n\t"\
		"vsubpd	%%ymm2,%%ymm0,%%ymm0		\n\t"\
		...
		"movslq	%[__p4],%%rdi		\n\t"\
		"shlq	$3,%%rdi			\n\t"\
		"vmovaps	0x400(%%rsi),%%ymm3	/* isrt2, using r1 as base-ptr */\n\t"\
		"addq	%%rdi,%%rax			\n\t"\
		"addq	%%rdi,%%rbx			\n\t"\
		"addq	%%rdi,%%rcx			\n\t"\
		"addq	%%rdi,%%rdx			\n\t"\
		"addq	$0x80,%%rsi		/* r5 */\n\t"\
		"vmovaps	0x200(%%rsi),%%ymm4	/* r5 */\n\t"\
		"vmovaps	0x220(%%rsi),%%ymm5	\n\t"\
		"vmovaps	0x300(%%rsi),%%ymm6	\n\t"\
		"vmovaps	0x320(%%rsi),%%ymm7	\n\t"\
		...
		"vmovaps	0x200(%%rsi),%%ymm4	\n\t"\
		"vmovaps	0x220(%%rsi),%%ymm5	\n\t"\
		"vmovaps	0x3e0(%%rsi),%%ymm3	/* cc0, using r3 as base-ptr */\n\t"\
		"vmovaps	0x400(%%rsi),%%ymm2	/* ss0, using r3 as base-ptr */\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmulpd	%%ymm3,%%ymm4,%%ymm4		\n\t"\
		"vmulpd	%%ymm3,%%ymm5,%%ymm5		\n\t"\
		...
		"vmovaps	0x100(%%rsi),%%ymm2	\n\t"\
		"vmovaps	0x120(%%rsi),%%ymm3	\n\t"\
		"vmovaps	0x3c0(%%rsi),%%ymm1	/* isrt2, using r3 as base-ptr */\n\t"\
		"vmovaps	%%ymm2,%%ymm0		\n\t"\
		...
		"vmovaps	0x200(%%rsi),%%ymm4	\n\t"\
		"vmovaps	0x220(%%rsi),%%ymm5	\n\t"\
		"vmovaps	0x360(%%rsi),%%ymm2	/* cc0, using r7 as base-ptr */\n\t"\
		"vmovaps	0x380(%%rsi),%%ymm3	/* ss0, using r7 as base-ptr */\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmulpd	%%ymm3,%%ymm4,%%ymm4		\n\t"\
		"vmulpd	%%ymm3,%%ymm5,%%ymm5		\n\t"\
		...
		"vmovaps	0x100(%%rsi),%%ymm2	\n\t"\
		"vmovaps	0x120(%%rsi),%%ymm3	\n\t"\
		"vmovaps	0x340(%%rsi),%%ymm1		/* isrt2, using r7 as base-ptr */\n\t"\
		"vmovaps	%%ymm2,%%ymm0		\n\t"\
	...
	"\n\t"/*...Block 1: 24 MOVapd, 26 ADD/SUBpd, 12 MULpd */\
		...
		"vaddpd	%%ymm7,%%ymm5,%%ymm5		\n\t"\
		"/* SSE2_RADIX4_DIT_4TWIDDLE_2ND_HALF_B(c0) */\n\t"\
		"addq	$0x160,%%rsi /* c0, incr from r25 */\n\t"\
		"vsubpd	%%ymm4,%%ymm2,%%ymm2		\n\t"\
		"vsubpd	%%ymm7,%%ymm0,%%ymm0		\n\t"\
		"vsubpd	%%ymm5,%%ymm3,%%ymm3		\n\t"\
		"vsubpd	%%ymm6,%%ymm1,%%ymm1		\n\t"\
	...
	"\n\t"/*...Block 2: 34 MOVapd, 36 ADD/SUBpd, 26 MULpd */\
		...
		"addq	%%rsi,%%rax			\n\t"/* add0 + p1 */\
		"addq	%%rax,%%rbx			\n\t"/* add0 + p5 */\
		"addq	$0x240,%%rcx	/* r3 +0x200 */\n\t"\
		"addq	$0x240,%%rdx	/* r11+0x200 */\n\t"\
		"movq	%[__isrt2],%%rsi		\n\t"\
		"vmovaps	     (%%rcx),%%ymm4		\n\t"\
		"vmovaps	0x020(%%rcx),%%ymm5	\n\t"\
		"vmovaps	0x20(%%rsi),%%ymm2	/* cc0 */\n\t"\
		"vmovaps	0x40(%%rsi),%%ymm3	/* ss0 */\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmulpd	%%ymm2,%%ymm4,%%ymm4		\n\t"\
		"vmulpd	%%ymm2,%%ymm5,%%ymm5		\n\t"\
	...
	"\n\t"/*...Block 3: 31 MOVapd, 32 ADD/SUBpd, 20 MULpd */\
		...
		"addq	%%rsi,%%rax			\n\t"/* add0 + p2 */\
		"addq	%%rax,%%rbx			\n\t"/* add0 + p6 */\
		"addq	$0x240,%%rcx	/* r5 +0x200 */\n\t"\
		"addq	$0x240,%%rdx	/* r13+0x200 */\n\t"\
		"movq	%[__isrt2],%%rsi	\n\t"\
	...
	"\n\t"/*...Block 4: 34 MOVapd, 36 ADD/SUBpd, 26 MULpd */\
		...
		"addq	%%rsi,%%rax			\n\t"/* add0 + p3 */\
		"addq	%%rax,%%rbx			\n\t"/* add0 + p7 */\
		"addq	$0x240,%%rcx	/* r7 +0x200 */\n\t"\
		"addq	$0x240,%%rdx	/* r15+0x200 */\n\t"\
		"movq	%[__isrt2],%%rsi		\n\t"\
		"vmovaps	     (%%rcx),%%ymm4	\n\t"\
		"vmovaps	0x020(%%rcx),%%ymm5	\n\t"\
		"vmovaps	0x20(%%rsi),%%ymm3	/* cc0 */\n\t"\
		"vmovaps	0x40(%%rsi),%%ymm2	/* ss0 */\n\t"\
		"vmovaps	%%ymm4,%%ymm6		\n\t"\
		"vmovaps	%%ymm5,%%ymm7		\n\t"\
		"vmulpd	%%ymm2,%%ymm4,%%ymm4		\n\t"\
		"vmulpd	%%ymm2,%%ymm5,%%ymm5		\n\t"\
...
"prefetcht1	%c[__pfetch_dist](%%r11)\n\t"/* ...+p13 */\
	...
	"prefetcht1	%c[__pfetch_dist](%%r13)\n\t"/* ...+p15 */\
		...
		: [__add0] "m" (Xadd0)	/* All inputs from memory addresses here */\
		 ...
		 ,[__pfetch_addr] "m" (Xpfetch_addr)\
		 ,[__pfetch_dist] "e" (Xpfetch_dist)\
		: "cc","memory","rax","rbx","rcx","rdx","rdi","rsi","r8","r9","r10","r11","r12","r13","r14","r15","xmm0","xmm1","xmm2","xmm3","xmm4","xmm5","xmm6","xmm7","xmm8","xmm9","xmm10","xmm11","xmm12","xmm13","xmm14","xmm15"	/* Clobbered registers */\
	);\
	}
	...
	"/*...Block 1: 24 MOVapd, 26 ADD/SUBpd, 12 MULpd */	/*...Block 3: 31 MOVapd, 32 ADD/SUBpd, 20 MULpd */\n\t"\
		...
		"vmulpd	0x060(%%rsi),%%ymm6,%%ymm6				\n\t	vmulpd	     (%%r14),%%ymm13,%%ymm13		\n\t"\
		"vsubpd	     %%ymm2,%%ymm5,%%ymm5				\n\t	vmulpd	0x040(%%r14),%%ymm9 ,%%ymm9 		\n\t"\
		"vsubpd	     %%ymm0,%%ymm1,%%ymm1				\n\t	vmulpd	0x060(%%r14),%%ymm8 ,%%ymm8 		\n\t"\
		"vaddpd	     %%ymm3,%%ymm4,%%ymm4				\n\t	vmulpd	0x020(%%r14),%%ymm11,%%ymm11		\n\t"\
		"vaddpd	     %%ymm6,%%ymm7,%%ymm7				\n\t	vmulpd	     (%%r14),%%ymm12,%%ymm12		\n\t"\
		"vmovaps	%%ymm5,0x020(%%rax)					\n\t	vmulpd	0x040(%%r14),%%ymm15,%%ymm15		\n\t"\
		"vmovaps	%%ymm1,0x020(%%rbx)					\n\t	vmulpd	0x060(%%r14),%%ymm14,%%ymm14		\n\t"\
		...
		"vmulpd	0x060(%%rsi),%%ymm7,%%ymm7				\n\t	vmulpd	     (%%r14),%%ymm13,%%ymm13		\n\t"\
		"vsubpd	     %%ymm2,%%ymm5,%%ymm5				\n\t	vmulpd	0x040(%%r14),%%ymm14,%%ymm14		\n\t"\
		"vsubpd	     %%ymm1,%%ymm6,%%ymm6				\n\t	vmulpd	0x060(%%r14),%%ymm9 ,%%ymm9 		\n\t"\
		"vaddpd	     %%ymm3,%%ymm4,%%ymm4				\n\t	vmulpd	0x020(%%r14),%%ymm11,%%ymm11		\n\t"\
		"vaddpd	     %%ymm7,%%ymm0,%%ymm0				\n\t	vmulpd	     (%%r14),%%ymm12,%%ymm12		\n\t"\
		"vmovaps	%%ymm5,0x020(%%rax)					\n\t	vmulpd	0x040(%%r14),%%ymm8 ,%%ymm8 		\n\t"\
		"vmovaps	%%ymm6,0x020(%%rbx)					\n\t	vmulpd	0x060(%%r14),%%ymm15,%%ymm15		\n\t"\
		"vmovaps	%%ymm4,     (%%rax)					\n\t	vsubpd	%%ymm10,%%ymm13,%%ymm13			\n\t"\
		"vmovaps	%%ymm0,     (%%rbx)					\n\t	vsubpd	%%ymm9 ,%%ymm14,%%ymm14			\n\t"\
		"/*...Block 2: 34 MOVapd, 36 ADD/SUB, 26 MUL */	\n\t	vaddpd	%%ymm11,%%ymm12,%%ymm12			\n\t"\
  ...
  #define USE_64BIT_ASM_STYLE	1	// My x86 timings indicate fancier versions below using xmm0-15 for the radix-16 DFT is faster.
	...
	#define FUCKME(Xadd0,Xp4,Xpfetch_addr,Xpfetch_dist)\
	{\
	__asm__ volatile (\
		"movq	%[__add0],%%rax						\n\t"\
	"movslq	%[__pfetch_addr],%%r15	\n\t"	/* Prefetch base-index offset cycles among add0 + p0,1,2,3 on successive macro calls */\
	"leaq	%c[__pfetch_dist](%%rax,%%r15,8),%%r15	\n\t"	/* [base-address + data-fetch-ahead index] */\
		"movslq	%[__p4],%%rbx						\n\t"\
		"shlq	$3,%%rbx							\n\t"\
	"movq	%%rbx,%%r14	\n\t"	/* Save a copy of p4 pointer offset. Will prefetch from [base-address + data-fetch-ahead index] + [0,p4,p8,p12] on each macro call. */\
	"prefetcht1	(%%r15)	\n\t"\
