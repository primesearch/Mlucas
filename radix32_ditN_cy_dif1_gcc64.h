...
#define radix32_ditN_cy_dif1_gcc_h_included
  ...
  #define USE_64BIT_ASM_STYLE	0	// Not currently supported for macros in this file, use as placeholder
	...
	/* Both DIF and DIT macros assume needed roots of unity laid out in memory relative to the input pointer isrt2 like so:
		...
		cc0: Real part of basic 16th root of 1 = c16								isrt2 + 0x20
		ss0: Real part of basic 16th root of 1 = s16								isrt2 + 0x40
		cc1: Real part of basic 32th root of 1 = c32_1								isrt2 + 0x60
		ss1: Real part of basic 32th root of 1 = s32_1								isrt2 + 0x80
		cc3: Real part of 3rd   32th root of 1 = c32_3								isrt2 + 0xa0
		ss3: Real part of 3rd   32th root of 1 = s32_3								isrt2 + 0xc0
	*/
	...
	/*...Block 1: */\
		...
		/* Can't simply addq these to a 64-bit base array address since the offsets are 4-bit array data: */\
		"movslq	0x0(%%rdi),%%rax	\n\t"/* p00 */\
		"movslq	0x4(%%rdi),%%rbx	\n\t"/* p01 */\
		"movslq	0x8(%%rdi),%%rcx	\n\t"/* p02 */\
		"movslq	0xc(%%rdi),%%rdx	\n\t"/* p03 */\
		...
		"vmovaps	%%ymm4,    (%%rsi)	\n\t"\
		"vmovaps	%%ymm7,0x40(%%rsi)	\n\t"\
		"vmovaps	%%ymm5,0x20(%%rsi)	\n\t"\
		"vmovaps	%%ymm6,0xe0(%%rsi)	\n\t"\
		...
		"vaddpd	      %%ymm5,%%ymm6,%%ymm6		\n\t"\
		"vmovaps		%%ymm0, 0x40(%%rsi)\n\t"\
		"vmovaps		%%ymm4, 0xc0(%%rsi)\n\t"\
		"vmovaps		%%ymm1, 0x60(%%rsi)\n\t"\
		"vmovaps		%%ymm5,-0x20(%%rsi)\n\t"\
		"vmovaps		%%ymm2,-0xc0(%%rsi)\n\t"\
		"vmovaps		%%ymm7,-0x40(%%rsi)\n\t"\
		"vmovaps		%%ymm3,-0xa0(%%rsi)\n\t"\
		"vmovaps		%%ymm6, 0xe0(%%rsi)\n\t"\
		"\n\t"\
	/*...Block 2: */\
		"addq	$0x100,%%rsi			\n\t"\
	...
	/*...Block 1: t00,t10,t20,t30 in r00,04,02,06 - note swapped middle 2 indices! */\
		...
		"vmovaps	0xe0(%%rsi),%%ymm7	\n\t"/* t39 */\
		"vmovaps	    (%%rsi),%%ymm0	\n\t"/* t08 */\
		"vsubpd	0x60(%%rsi),%%ymm4,%%ymm4	\n\t"/* t28-t29 */\
		"vmovaps	0x20(%%rsi),%%ymm1	\n\t"/* t09 */\
		"vaddpd	0x40(%%rsi),%%ymm5,%%ymm5	\n\t"/* t29+t28 */\
		"vmovaps	0x80(%%rsi),%%ymm2	\n\t"/* t18 */\
		"vmulpd	    (%%rdi),%%ymm4,%%ymm4		\n\t"/* t28 = (t28-t29)*ISRT2 */\
		"vmovaps	0xa0(%%rsi),%%ymm3	\n\t"/* t19 */\
		"vmulpd	    (%%rdi),%%ymm5,%%ymm5		\n\t"/* t29 = (t29+t28)*ISRT2 */\
		"vsubpd	0xa0(%%rsi),%%ymm0,%%ymm0	\n\t"/* t08=t08-t19*/\
		"vaddpd	0xe0(%%rsi),%%ymm6,%%ymm6	\n\t"/* t38+t39 */\
		"vsubpd	0x80(%%rsi),%%ymm1,%%ymm1	\n\t"/* t19=t09-t18*/\
		"vsubpd	0xc0(%%rsi),%%ymm7,%%ymm7	\n\t"/* t39-t38 */\
		"vaddpd	0x20(%%rsi),%%ymm2,%%ymm2	\n\t"/* t09=t18+t09*/\
		"vmulpd	    (%%rdi),%%ymm6,%%ymm6		\n\t"/*  rt = (t38+t39)*ISRT2 */\
		...
		"vmovaps	0xa0(%%rsi),%%ymm3	\n\t"/* t1D */\
		"vsubpd	      %%ymm7,%%ymm5,%%ymm5		\n\t"/*~t2D=t2D-it */\
		"vaddpd	0xa0(%%rsi),%%ymm2,%%ymm2	\n\t"/* t1C+t1D */\
		"vaddpd	      %%ymm6,%%ymm6,%%ymm6		\n\t"/*      2* rt */\
		"vsubpd	0x80(%%rsi),%%ymm3,%%ymm3	\n\t"/* t1D-t1C */\
		"vaddpd	      %%ymm7,%%ymm7,%%ymm7		\n\t"/*      2* it */\
		"vmulpd	    (%%rdi),%%ymm2,%%ymm2		\n\t"/* rt = (t1C+t1D)*ISRT2 */\
		"vaddpd	      %%ymm4,%%ymm6,%%ymm6		\n\t"/*~t3C=t2C+rt */\
		"vmulpd	    (%%rdi),%%ymm3,%%ymm3		\n\t"/* it = (t1D-t1C)*ISRT2 */\
		...
		"vmovaps	0x60(%%rsi),%%ymm1	\n\t"/* copy t2B */\
		"vmovaps	0xe0(%%rsi),%%ymm3	\n\t"/* copy t3B */\
		"vmulpd	0xa0(%%rdi),%%ymm4,%%ymm4	\n\t"/* t2A*s32_3 */\
		"vmulpd	0x40(%%rdi),%%ymm6,%%ymm6	\n\t"/* t3A*c32_1 */\
		"vmulpd	0x80(%%rdi),%%ymm1,%%ymm1	\n\t"/* t2B*c32_3 */\
		"vmulpd	0x60(%%rdi),%%ymm3,%%ymm3	\n\t"/* t3B*s32_1 */\
		"vmulpd	0xa0(%%rdi),%%ymm5,%%ymm5	\n\t"/* t2B*s32_3 */\
		"vmulpd	0x40(%%rdi),%%ymm7,%%ymm7	\n\t"/* t3B*c32_1 */\
		"vmulpd	0x80(%%rdi),%%ymm0,%%ymm0	\n\t"/* t2A*c32_3 */\
		"vmulpd	0x60(%%rdi),%%ymm2,%%ymm2	\n\t"/* t3A*s32_1 */\
		"vsubpd	      %%ymm1,%%ymm4,%%ymm4		\n\t"/* ~t2A */\
		"vaddpd	      %%ymm3,%%ymm6,%%ymm6		\n\t"/* rt */\
		"vaddpd	      %%ymm0,%%ymm5,%%ymm5		\n\t"/* ~t2B */\
		...
		"vmovaps	0x60(%%rsi),%%ymm1	\n\t"/* copy t2F */\
		"vmovaps	0xe0(%%rsi),%%ymm3	\n\t"/* copy t3F */\
		"vmulpd	0x60(%%rdi),%%ymm4,%%ymm4	\n\t"/* t2E*s32_1 */\
		"vmulpd	0xa0(%%rdi),%%ymm6,%%ymm6	\n\t"/* t3E*c32_3 */\
		"vmulpd	0x40(%%rdi),%%ymm1,%%ymm1	\n\t"/* t2F*c32_1 */\
		"vmulpd	0x80(%%rdi),%%ymm3,%%ymm3	\n\t"/* t3F*s32_3 */\
		"vmulpd	0x60(%%rdi),%%ymm5,%%ymm5	\n\t"/* t2F*s32_1 */\
		"vmulpd	0xa0(%%rdi),%%ymm7,%%ymm7	\n\t"/* t3F*c32_3 */\
		"vmulpd	0x40(%%rdi),%%ymm0,%%ymm0	\n\t"/* t2E*c32_1 */\
		"vmulpd	0x80(%%rdi),%%ymm2,%%ymm2	\n\t"/* t3E*s32_3 */\
		"vsubpd	      %%ymm1,%%ymm4,%%ymm4		\n\t"/* ~t2E */\
		"vsubpd	      %%ymm3,%%ymm6,%%ymm6		\n\t"/* rt */\
		"vaddpd	      %%ymm0,%%ymm5,%%ymm5		\n\t"/* ~t2F */\
		"vaddpd	      %%ymm2,%%ymm7,%%ymm7		\n\t"/* it */\
