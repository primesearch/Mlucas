...
*/
  ...
  #ifdef DEBUG_SSE2
	int iloop;
	double v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16,v17,v18,v19,v20,v21,v22,v23,v24,v25,v26,v27,v28,v29,v30,v31,v32;
	double w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w16,w17,w18,w19,w20,w21,w22,w23,w24,w25,w26,w27,w28,w29,w30,w31,w32;
...
/*...If a new runlength or first-pass radix, set first_entry to true:	*/
	...
	*/
		...
		if(!index_ptmp){ sprintf(cbuf,"FATAL: unable to allocate array INDEX in radix16_wrapper_square.\n"); fprintf(stderr,"%s", cbuf);	ASSERT(HERE, 0,cbuf); }
	...
	*/
	...
	if(!i) { sprintf(cbuf,"ERROR 10 in radix16_wrapper_square\n"); fprintf(stderr,"%s", cbuf);	ASSERT(HERE, 0,cbuf); }
	...
	*/
	if(j1 == 0)
	{
	  ...
	  j2pad = j2 + ( (j2 >> DAT_BITS) << PAD_BITS );	/* floating padded-array 2nd element index is here */
		...
		re=cB1;	im=sB1;		/* The j1 = 0 case is special... */
	...
	/*...Block 1: */
		t1 =a[rdum   ];	t2 =a[idum   ];
		rt =a[rdum+16];	it =a[idum+16];
		t3 =t1 -rt;	t1 =t1 +rt;
		t4 =t2 -it;	t2 =t2 +it;

		t5 =a[rdum+8 ];	t6 =a[idum+8 ];
		rt =a[rdum+24];	it =a[idum+24];
		t7 =t5 -rt;	t5 =t5 +rt;
		t8 =t6 -it;	t6 =t6 +it;
		...
		rt =t7;	t7 =t3 +t8;	t3 =t3 -t8;
				t8 =t4 -rt;	t4 =t4 +rt;
	/*...Block 2: */
		t9 =a[rdum+4 ];	t10=a[idum+4 ];
		rt =a[rdum+20];	it =a[idum+20];
		t11=t9 -rt;	t9 =t9 +rt;
		t12=t10-it;	t10=t10+it;

		t13=a[rdum+12];	t14=a[idum+12];
		rt =a[rdum+28];	it =a[idum+28];
	...
	/*...Block 3: */
		...
		--idum;
	#endif
		t17=a[rdum+2 ];	t18=a[idum+2 ];
		rt =a[rdum+18];	it =a[idum+18];
		t19=t17-rt;	t17=t17+rt;
		t20=t18-it;	t18=t18+it;

		t21=a[rdum+10];	t22=a[idum+10];
		rt =a[rdum+26];	it =a[idum+26];
	...
	/*...Block 4: */
		t25=a[rdum+6 ];	t26=a[idum+6 ];
		rt =a[rdum+22];	it =a[idum+22];
		t27=t25-rt;	t25=t25+rt;
		t28=t26-it;	t26=t26+it;

		t29=a[rdum+14];	t30=a[idum+14];
		rt =a[rdum+30];	it =a[idum+30];
...
/*...Block 1: t1,9,17,25 */
		...
		a[rdum+16]=t1-t17;	a[idum+16]=t2-t18;

		a[rdum+8 ]=t9 +t26;	a[idum+8 ]=t10-t25;
		a[rdum+24]=t9 -t26;	a[idum+24]=t10+t25;
...
/*...Block 3: t5,13,21,29 */
		...
		a[rdum+4 ]=t5 +t21;	a[idum+4 ]=t6 +t22;
		a[rdum+20]=t5 -t21;	a[idum+20]=t6 -t22;

		a[rdum+12]=t13+t30;	a[idum+12]=t14-t29;
		a[rdum+28]=t13-t30;	a[idum+28]=t14+t29;
...
/*...Block 2: t3,11,19,27 */
		...
		a[rdum+2 ]=t3 +t19;	a[idum+2 ]=t4 +t20;
		a[rdum+18]=t3 -t19;	a[idum+18]=t4 -t20;

		a[rdum+10]=t11+t28;	a[idum+10]=t12-t27;
		a[rdum+26]=t11-t28;	a[idum+26]=t12+t27;
...
/*...Block 4: t7,15,23,31 */
		...
		a[rdum+6 ]=t7 +t23;	a[idum+6 ]=t8 +t24;
		a[rdum+22]=t7 -t23;	a[idum+22]=t8 -t24;

		a[rdum+14]=t15+t32;	a[idum+14]=t16-t31;
		a[rdum+30]=t15-t32;	a[idum+30]=t16+t31;
...
jump_in:	/* Entry point for all blocks but the first. */
	...
	if(j1 == 0){ re= rt;	im= it; }   /* The j1 = 0 case is special... */
		...
		//	fprintf(stderr, "radix16_wrapper: A_in[%2d] = %20.5f, %20.5f\n",iloop,a[j1pad+iloop],a[j2pad+iloop]);
		}
	  #endif
...
*/
		...
		*/
		...
		tmp0->im = t6;		tmp1->im = t5;

		tmp2->re = t1;		tmp3->re = t2;
		tmp2->im = t4;		tmp3->im = t3;
		...
		__asm__ volatile (\
			...
			: [tmp0] "m" (tmp0)	// All inputs from memory addresses here
			 ...
			 ,[tmp2] "m" (tmp2)
			 ,[tmp3] "m" (tmp3)
			: "rax","rbx","rcx","rdx","xmm0","xmm1","xmm2","xmm3"		/* Clobbered registers */\
		);
	...
	*/
	...
	#ifdef DEBUG_SSE2
		fprintf(stderr, "radix16_wrapper: R1:= %20.5f, %20.5f\n",r1 ->re,r2 -> re);
		fprintf(stderr, "radix16_wrapper: R3:= %20.5f, %20.5f\n",r3 ->re,r4 -> re);
		fprintf(stderr, "radix16_wrapper: R5:= %20.5f, %20.5f\n",r5 ->re,r6 -> re);
		fprintf(stderr, "radix16_wrapper: R7:= %20.5f, %20.5f\n",r7 ->re,r8 -> re);
		fprintf(stderr, "radix16_wrapper: R9:= %20.5f, %20.5f\n",r9 ->re,r10-> re);
		fprintf(stderr, "radix16_wrapper: R11= %20.5f, %20.5f\n",r11->re,r12-> re);
		fprintf(stderr, "radix16_wrapper: R13= %20.5f, %20.5f\n",r13->re,r14-> re);
		fprintf(stderr, "radix16_wrapper: R15= %20.5f, %20.5f\n",r15->re,r16-> re);
		fprintf(stderr, "radix16_wrapper: R17= %20.5f, %20.5f\n",r17->re,r18-> re);
		fprintf(stderr, "radix16_wrapper: R19= %20.5f, %20.5f\n",r19->re,r20-> re);
		fprintf(stderr, "radix16_wrapper: R21= %20.5f, %20.5f\n",r21->re,r22-> re);
		fprintf(stderr, "radix16_wrapper: R23= %20.5f, %20.5f\n",r23->re,r24-> re);
		fprintf(stderr, "radix16_wrapper: R25= %20.5f, %20.5f\n",r25->re,r26-> re);
		fprintf(stderr, "radix16_wrapper: R27= %20.5f, %20.5f\n",r27->re,r28-> re);
		fprintf(stderr, "radix16_wrapper: R29= %20.5f, %20.5f\n",r29->re,r30-> re);
		fprintf(stderr, "radix16_wrapper: R31= %20.5f, %20.5f\n",r31->re,r32-> re);
		exit(0);
	#endif
	...
	/*...Block 1: */
		t1 =a[rdum   ];							t2 =a[idum   ];
		rt =a[rdum+16]*cA8 -a[idum+16]*sA8 ;	it =a[idum+16]*cA8 +a[rdum+16]*sA8;
		t3 =t1 -rt;	t1 =t1 +rt;
		t4 =t2 -it;	t2 =t2 +it;

		t5 =a[rdum+8 ]*cA4 -a[idum+8 ]*sA4;		t6 =a[idum+8 ]*cA4 +a[rdum+8 ]*sA4;
		rt =a[rdum+24]*cA12-a[idum+24]*sA12;	it =a[idum+24]*cA12+a[rdum+24]*sA12;
		t7 =t5 -rt;	t5 =t5 +rt;
		t8 =t6 -it;	t6 =t6 +it;
		...
		rt =t7;	t7 =t3 +t8;	t3 =t3 -t8;
				t8 =t4 -rt;	t4 =t4 +rt;
	/*...Block 2: */
		t9 =a[rdum+4 ]*cA2 -a[idum+4 ]*sA2 ;	t10=a[idum+4 ]*cA2 +a[rdum+4 ]*sA2 ;
		rt =a[rdum+20]*cA10-a[idum+20]*sA10;	it =a[idum+20]*cA10+a[rdum+20]*sA10;
		t11=t9 -rt;	t9 =t9 +rt;
		t12=t10-it;	t10=t10+it;

		t13=a[rdum+12]*cA6 -a[idum+12]*sA6 ;	t14=a[idum+12]*cA6 +a[rdum+12]*sA6 ;
		rt =a[rdum+28]*cA14-a[idum+28]*sA14;	it =a[idum+28]*cA14+a[rdum+28]*sA14;
		t15=t13-rt;	t13=t13+rt;
		t16=t14-it;	t14=t14+it;
	...
	/*...Block 3: */
		...
		--idum;
	#endif
		t17=a[rdum+2 ]*cA1 -a[idum+2 ]*sA1 ;	t18=a[idum+2 ]*cA1 +a[rdum+2 ]*sA1 ;
		rt =a[rdum+18]*cA9 -a[idum+18]*sA9 ;	it =a[idum+18]*cA9 +a[rdum+18]*sA9 ;
		t19=t17-rt;	t17=t17+rt;
		t20=t18-it;	t18=t18+it;

		t21=a[rdum+10]*cA5 -a[idum+10]*sA5 ;	t22=a[idum+10]*cA5 +a[rdum+10]*sA5 ;
		rt =a[rdum+26]*cA13-a[idum+26]*sA13;	it =a[idum+26]*cA13+a[rdum+26]*sA13;
		t23=t21-rt;	t21=t21+rt;
		t24=t22-it;	t22=t22+it;
		...
		rt =t23;	t23=t19+t24;t19=t19-t24;
					t24=t20-rt;	t20=t20+rt;
	/*...Block 4: */
		t25=a[rdum+6 ]*cA3 -a[idum+6 ]*sA3 ;	t26=a[idum+6 ]*cA3 +a[rdum+6 ]*sA3 ;
		rt =a[rdum+22]*cA11-a[idum+22]*sA11;	it =a[idum+22]*cA11+a[rdum+22]*sA11;
		t27=t25-rt;	t25=t25+rt;
		t28=t26-it;	t26=t26+it;

		t29=a[rdum+14]*cA7 -a[idum+14]*sA7 ;	t30=a[idum+14]*cA7 +a[rdum+14]*sA7 ;
		rt =a[rdum+30]*cA15-a[idum+30]*sA15;	it =a[idum+30]*cA15+a[rdum+30]*sA15;
		t31=t29-rt;	t29=t29+rt;
		t32=t30-it;	t30=t30+it;
...
*/
	  ...
	  else
	  {
		...
		#error radix16_wrapper square: please use SSE2-style pair_square call sequence!
	  /*
		pair_square(&aj1p0r ,&aj1p0i ,&aj2p15r,&aj2p15i, re, im);	pair_square(&aj2p14r,&aj2p14i,&aj1p1r ,&aj1p1i ,-re, im);
		pair_square(&aj1p2r ,&aj1p2i ,&aj2p13r,&aj2p13i,-im, re);	pair_square(&aj2p12r,&aj2p12i,&aj1p3r ,&aj1p3i , im, re);
	  */
		...
		rt=(re-im)*ISRT2;	it=(re+im)*ISRT2;
	  /*
		pair_square(&aj1p4r ,&aj1p4i ,&aj2p11r,&aj2p11i, rt, it);	pair_square(&aj2p10r,&aj2p10i,&aj1p5r ,&aj1p5i ,-rt, it);
		pair_square(&aj1p6r ,&aj1p6i ,&aj2p9r ,&aj2p9i ,-it, rt);	pair_square(&aj2p8r ,&aj2p8i ,&aj1p7r ,&aj1p7i , it, rt);
	  */
		PAIR_SQUARE2A(aj1p4r ,aj1p4i ,aj2p11r,aj2p11i,aj1p6r ,aj1p6i ,aj2p9r ,aj2p9i , rt, it);
		PAIR_SQUARE2B(aj2p10r,aj2p10i,aj1p5r ,aj1p5i ,aj2p8r ,aj2p8i ,aj1p7r ,aj1p7i , rt, it);

		t3=re*c;	t4=im*s;	t5=re*s;	t6=im*c;
		rt=t3-t4;	it=t5+t6;
	  /*
		pair_square(&aj1p8r ,&aj1p8i ,&aj2p7r ,&aj2p7i , rt, it);	pair_square(&aj2p6r ,&aj2p6i ,&aj1p9r ,&aj1p9i ,-rt, it);
		pair_square(&aj1p10r,&aj1p10i,&aj2p5r ,&aj2p5i ,-it, rt);	pair_square(&aj2p4r ,&aj2p4i ,&aj1p11r,&aj1p11i, it, rt);
	  */
		PAIR_SQUARE2A(aj1p8r ,aj1p8i ,aj2p7r ,aj2p7i ,aj1p10r,aj1p10i,aj2p5r ,aj2p5i , rt, it);
		PAIR_SQUARE2B(aj2p6r ,aj2p6i ,aj1p9r ,aj1p9i ,aj2p4r ,aj2p4i ,aj1p11r,aj1p11i, rt, it);

		rt=t5-t6;	it=t3+t4;
	  /*
		pair_square(&aj1p12r,&aj1p12i,&aj2p3r ,&aj2p3i , rt, it);	pair_square(&aj2p2r ,&aj2p2i ,&aj1p13r,&aj1p13i,-rt, it);
		pair_square(&aj1p14r,&aj1p14i,&aj2p1r ,&aj2p1i ,-it, rt);	pair_square(&aj2p0r ,&aj2p0i ,&aj1p15r,&aj1p15i, it, rt);
	  */
		PAIR_SQUARE2A(aj1p12r,aj1p12i,aj2p3r ,aj2p3i ,aj1p14r,aj1p14i,aj2p1r ,aj2p1i , rt, it);
		PAIR_SQUARE2B(aj2p2r ,aj2p2i ,aj1p13r,aj1p13i,aj2p0r ,aj2p0i ,aj1p15r,aj1p15i, rt, it);
