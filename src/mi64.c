...
{														// lenu = unpadded length
	...
	increments. Narrowing the declarations above to #ifndef YES_ASM dropped them, and without
	them that arm does not compile - it is taken by every x86-64 build below AVX2. */
	uint64 *iptr1,*iptr2;
