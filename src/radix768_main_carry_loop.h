...
for(k=1; k <= khi; k++)	/* Do n/(radix(1)*nwt) outer loop executions...	*/
{
	...
	/*...and now do 256 radix-3 transforms: */
	  #if OS_BITS == 64	// Dec 2014: Data-doubled-radix-3 versions slightly faster if enough register available
		...
		for(l1 = 0; l1 < 48; l1 += 3) {
			k0 = dit_triplets[l1]; k1 = dit_triplets[l1+1]; k2 = dit_triplets[l1+2];
			l2 = 0x1e;	vd0 = s1p000+l2; vd1 = vd0+k1; vd2 = vd0+k2; vd0 += k0; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x1c;	vd0 = s1p000+l2; vd1 = vd0+k2; vd2 = vd0+k0; vd0 += k1; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x1a;	vd0 = s1p000+l2; vd1 = vd0+k0; vd2 = vd0+k1; vd0 += k2; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x18;	vd0 = s1p000+l2; vd1 = vd0+k1; vd2 = vd0+k2; vd0 += k0; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x16;	vd0 = s1p000+l2; vd1 = vd0+k2; vd2 = vd0+k0; vd0 += k1; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x14;	vd0 = s1p000+l2; vd1 = vd0+k0; vd2 = vd0+k1; vd0 += k2; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x12;	vd0 = s1p000+l2; vd1 = vd0+k1; vd2 = vd0+k2; vd0 += k0; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x10;	vd0 = s1p000+l2; vd1 = vd0+k2; vd2 = vd0+k0; vd0 += k1; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x0e;	vd0 = s1p000+l2; vd1 = vd0+k0; vd2 = vd0+k1; vd0 += k2; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x0c;	vd0 = s1p000+l2; vd1 = vd0+k1; vd2 = vd0+k2; vd0 += k0; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x0a;	vd0 = s1p000+l2; vd1 = vd0+k2; vd2 = vd0+k0; vd0 += k1; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x08;	vd0 = s1p000+l2; vd1 = vd0+k0; vd2 = vd0+k1; vd0 += k2; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x06;	vd0 = s1p000+l2; vd1 = vd0+k1; vd2 = vd0+k2; vd0 += k0; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x04;	vd0 = s1p000+l2; vd1 = vd0+k2; vd2 = vd0+k0; vd0 += k1; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
			l2 = 0x02;	vd0 = s1p000+l2; vd1 = vd0+k0; vd2 = vd0+k1; vd0 += k2; SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; l &= 0x1ff; tmp = r000+l; tm1 = tmp+512; tm2 = tmp+1024;	/* needed for final-loop-pass wraparound of 0-term */
						vd0 = s1p000+k0; vd1 = s1p000+k1; vd2 = s1p000+k2;      SSE2_RADIX_03_DFT(tmp,tm1,tm2, cc1, vd0,vd1,vd2); l+=2; tmp+=2; tm1+=2; tm2+=2;
		}
...
/*...Now do the carries. Since the outputs would
	normally be getting dispatched to 48 separate blocks of the A-array, we need 48 separate carries.	*/
	  ...
	  #else
		const uint32 nloop = RADIX>>3;		incr = 8;
	  #endif
		i = (!j);	// Need this to force 0-wod to be bigword
		tmp = s1p000; tm1 = cy; tm2 = cy+1; itmp = bjmodn; itm2 = bjmodn+4;	// tm2,itm2 not used in AVX-512 mode
		...
		incr = 8;	// incr must divide radix/4!
		for(loop = 0; loop < nloop; loop += incr)
		{
	...
	/*...gather the needed data (768 64-bit complex) and do 256 radix-3 transforms - We want unit-strides in the radix768-DFT macro, so use large output strides here: */
		...
		l = 1; l1 = l+256; l2 = l+512;	// Skip 0-term, which gets saved for wraparound
		for(m = 0; m < 144; m += 9) {
			k0 = dif_triplets[m  ]; k1 = dif_triplets[m+1]; k2 = dif_triplets[m+2];
			...
			k0 = dif_triplets[m+3]; k1 = dif_triplets[m+4]; k2 = dif_triplets[m+5];
			...
			k0 = dif_triplets[m+6]; k1 = dif_triplets[m+7]; k2 = dif_triplets[m+8];
