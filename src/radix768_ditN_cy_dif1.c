...
/*...stuff for the reduced-length DWT weights array is here:	*/
	...
	static task_control_t   task_control = {NULL, cy768_process_chunk, NULL, 0x0};
...
/*...The radix-768 pass is here.	*/
	...
	*/
		...
		//                               vvv
		RADIX_256_DIF(t_u.d,1,i_offsets_lo,i_offsets_hi, (a+j1     ),RE_IM_STRIDE,o_offsets_lo,o_idx1,o_offsets_hi1);	/* Inputs in t[ 00- ff] */
...
/*...The radix-768 pass is here.	*/
	...
	*/
	/*...gather the needed data (768 64-bit complex) and do 3 radix-256 transforms,	*/
		...
		//                                                                                              vvv
		RADIX_256_DIT((a+j1     ),RE_IM_STRIDE,(int *)(i_offsets_lo+0x00),i_idx1,i_offsets_hi1, t_u.d,1,o_offsets_lo,o_offsets_hi);	/* Outputs in t[ 00- ff] */
...
/******************** Multithreaded function body - NO STATIC VARS BELOW THIS POINT!: ***************************/
	...
	void
	cy768_process_chunk(void*targ, int thread_num)	// Thread-arg pointer *must* be cast to void and specialized inside the function
	{
