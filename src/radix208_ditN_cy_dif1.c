...
const double cc1=  0.88545602565320989590,	/* Real part of exp(i*2*pi/13), the radix-13 fundamental sincos datum	*/
  ...
  #ifdef USE_AVX512
	const int incr_long[] = {13}, incr_med[] = {6,7}, incr_short[] = {4,5,4};
  #elif defined(USE_AVX)
	const int incr_long[] = {13,13}, incr_med[] = {9,8,9}, incr_short[] = {4,5,4,4,5,4};
  #else
	const int incr_long[] = {13,13,13,13}, incr_med[] = {9,8,9,9,8,9}, incr_short[] = {4,5,4,4,5,4,4,5,4,4,5,4};
  #endif
...
/*...initialize things upon first entry: */
	...
	// sc_ptr += 0x36a
		...
		nbytes = (long)tmp - (long)two;	// #bytes in above sincos block of data
		tmp = two;
