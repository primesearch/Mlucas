...
/*...stuff for the reduced-length DWT weights array is here:	*/
	...
	static task_control_t   task_control = {NULL, cy960_process_chunk, NULL, 0x0};
...
/******************** Multithreaded function body - NO STATIC VARS BELOW THIS POINT!: ***************************/
	...
	void
	cy960_process_chunk(void*targ, int thread_num)	// Thread-arg pointer *must* be cast to void and specialized inside the function
	{
