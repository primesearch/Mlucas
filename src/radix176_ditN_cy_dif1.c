...
#if defined(USE_SSE2) && !((defined(USE_AVX2) && DFT_11_FMA) || defined(USE_ARM_V8_SIMD))	// FMA version based on simple radix-11 DFT implementation, same as LO_ADD
...
//printf("dif_pcshft = ");for(kk=0;kk<21;kk++){printf("%u.",dif_pcshft[kk]);}printf("\n");exit(0);
	...
	// DIT:
		...
		vec_dbl *two,/* *one,*sqrt2, */*isrt2, /* *cc0,*ss0, *five, */ *ua0,/* *ua1,*ua2,*ua3,*ua4,*ua5,*ua6,*ua7,*ua8,*ua9, *ub0,*ub1,*ub2,*ub3,*ub4,*ub5,*ub6,*ub7,*ub8,*ub9, */ *max_err,
		  #ifndef USE_AVX512
			*sse2_rnd,
		  #endif
			*half_arr,
