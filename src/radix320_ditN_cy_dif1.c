...
*/
  ...
  #endif
	int NDIVR,i,j,j1,j2,jt,jp,jstart,jhi,full_pass,k,khi,l,ntmp,outer,nbytes, ilo,ihi,hi_neg,k0,k1,k2,k3,k4,nshift;
...
/*...initialize things upon first entry: */
	...
	if(first_entry)
	{
		...
		*/
		...
		half_arr= tmp + 0x02;
	  #endif
		ASSERT(HERE, (radix320_creals_in_local_store << l2_sz_vd) >= ((long)half_arr - (long)r00) + (20 << l2_sz_vd), "radix320_creals_in_local_store checksum failed!");
		/* These remain fixed: */
