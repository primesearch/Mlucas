...
#define carry_gcc_h_included
	...
	#define SSE2_cmplx_carry_norm_pow2_nocheck1_2B(Xdata,XwtA,XwtB,XwtC,XcyA,XcyB,Xbjmod_0,Xhalf_arr,Xn_minus_silp1,Xn_minus_sil,Xsign_mask,Xsinwt,Xsinwtm1,Xsse_bw,Xsse_nm1,Xsse_sw)\
	{\
	__asm__ volatile (\
	"/***************Unpack the data:*************************/\n\t"\
		"movq	%[__data]	,%%rax	\n\t"\
	...
	#define SSE2_cmplx_carry_norm_pow2_nocheck2_2B(Xdata,XwtA,XwtB,XcyA,XcyB,Xbjmod_0,Xhalf_arr,Xn_minus_silp1,Xn_minus_sil,Xsign_mask,Xsinwt,Xsinwtm1,Xsse_bw,Xsse_nm1,Xsse_sw)\
	{\
	__asm__ volatile (\
	"/**********************************************/\n\t"\
	"/*          Real      parts                   */\n\t"\
