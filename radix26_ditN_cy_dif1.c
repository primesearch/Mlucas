...
*/
	...
	static uint32 bw,sw,bjmodnini,p01,p02,p03,p04,p05,p06,p07,p08,p09,p10,p11,p12,p13,p14,p15,p16,p17,p18,p19,p20,p21,p22,p23,p24,p25;
...
/*...change n26 and n_div_wt to non-static to work around a gcc compiler bug. */
	...
	{
		sprintf(cbuf,"FATAL: iter = %10d; NWT_BITS does not divide N/26 in radix26_ditN_cy_dif1.\n",iter);
...
/*...The radix-26 final DIT pass is here.	*/
	...
	{
		ASSERT(HERE,0,"Radix-26 currently only supports LL test mode!");
	}
...
/*...set0 is slightly different from others:	*/
		 cmplx_carry_norm_errcheck0(aj1p00r,aj1p00i,cy00,bjmodn00   );
			...
			cmplx_carry_norm_errcheck(aj1p22r,aj1p22i,cy22,bjmodn22,22);
			cmplx_carry_norm_errcheck(aj1p23r,aj1p23i,cy23,bjmodn23,23);
			cmplx_carry_norm_errcheck(aj1p24r,aj1p24i,cy24,bjmodn24,24);
			cmplx_carry_norm_errcheck(aj1p25r,aj1p25i,cy25,bjmodn25,25);
...
*/
	...
	{
			sprintf(cbuf,"FATAL: iter = %10d; nonzero exit carry in radix26_ditN_cy_dif1 - input wordsize may be too small.\n",iter);
			if(INTERACT)fprintf(stderr,"%s",cbuf);
			fp = fopen(   OFILE,"a");
			fq = fopen(STATFILE,"a");
		fprintf(fp,"%s",cbuf);
...
*/
	...
	,aj1p00r,aj1p01r,aj1p02r,aj1p03r,aj1p04r,aj1p05r,aj1p06r,aj1p07r,aj1p08r,aj1p09r,aj1p10r,aj1p11r,aj1p12r,aj1p13r,aj1p14r,aj1p15r,aj1p16r,aj1p17r,aj1p18r,aj1p19r,aj1p20r,aj1p21r,aj1p22r,aj1p23r,aj1p24r,aj1p25r
	,aj1p00i,aj1p01i,aj1p02i,aj1p03i,aj1p04i,aj1p05i,aj1p06i,aj1p07i,aj1p08i,aj1p09i,aj1p10i,aj1p11i,aj1p12i,aj1p13i,aj1p14i,aj1p15i,aj1p16i,aj1p17i,aj1p18i,aj1p19i,aj1p20i,aj1p21i,aj1p22i,aj1p23i,aj1p24i,aj1p25i
	,cy00,cy01,cy02,cy03,cy04,cy05,cy06,cy07,cy08,cy09,cy10,cy11,cy12,cy13,cy14,cy15,cy16,cy17,cy18,cy19,cy20,cy21,cy22,cy23,cy24,cy25,temp,scale;
#if PFETCH
	double *add0, *addr;
#endif
	int err;
...
/*...set0 is slightly different from others:	*/
		 cmplx_carry_norm_nocheck0(aj1p00r,aj1p00i,cy00,bjmodn00   );
			cmplx_carry_norm_nocheck(aj1p01r,aj1p01i,cy01,bjmodn01,1 );
			cmplx_carry_norm_nocheck(aj1p02r,aj1p02i,cy02,bjmodn02,2 );
			cmplx_carry_norm_nocheck(aj1p03r,aj1p03i,cy03,bjmodn03,3 );
			cmplx_carry_norm_nocheck(aj1p04r,aj1p04i,cy04,bjmodn04,4 );
			cmplx_carry_norm_nocheck(aj1p05r,aj1p05i,cy05,bjmodn05,5 );
			cmplx_carry_norm_nocheck(aj1p06r,aj1p06i,cy06,bjmodn06,6 );
			cmplx_carry_norm_nocheck(aj1p07r,aj1p07i,cy07,bjmodn07,7 );
			cmplx_carry_norm_nocheck(aj1p08r,aj1p08i,cy08,bjmodn08,8 );
			cmplx_carry_norm_nocheck(aj1p09r,aj1p09i,cy09,bjmodn09,9 );
			...
			cmplx_carry_norm_nocheck(aj1p13r,aj1p13i,cy13,bjmodn13,13);
			cmplx_carry_norm_nocheck(aj1p14r,aj1p14i,cy14,bjmodn14,14);
			cmplx_carry_norm_nocheck(aj1p15r,aj1p15i,cy15,bjmodn15,15);
			cmplx_carry_norm_nocheck(aj1p16r,aj1p16i,cy16,bjmodn16,16);
			cmplx_carry_norm_nocheck(aj1p17r,aj1p17i,cy17,bjmodn17,17);
			cmplx_carry_norm_nocheck(aj1p18r,aj1p18i,cy18,bjmodn18,18);
			cmplx_carry_norm_nocheck(aj1p19r,aj1p19i,cy19,bjmodn19,19);
			cmplx_carry_norm_nocheck(aj1p20r,aj1p20i,cy20,bjmodn20,20);
			cmplx_carry_norm_nocheck(aj1p21r,aj1p21i,cy21,bjmodn21,21);
			cmplx_carry_norm_nocheck(aj1p22r,aj1p22i,cy22,bjmodn22,22);
			cmplx_carry_norm_nocheck(aj1p23r,aj1p23i,cy23,bjmodn23,23);
			cmplx_carry_norm_nocheck(aj1p24r,aj1p24i,cy24,bjmodn24,24);
			cmplx_carry_norm_nocheck(aj1p25r,aj1p25i,cy25,bjmodn25,25);
