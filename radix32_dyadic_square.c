	...
	*/
	...
	/* In SSE2 mode, also need next set of sincoa to put into "Imaginary" slots: */
		...
		for(iloop = 0; iloop <128; iloop += 4)
		{
			...
			fprintf(stderr, "radix32_dyadic_square: A_in[%2d] = %20.5f, %20.5f\n",iloop,a[j1+iloop+0],a[j1+iloop+2]);
...
/*       gather the needed data (32 64-bit complex, i.e. 64 64-bit reals) and do the first set of four length-8 transforms...
	...
	***************************************************************************************************************************/
	...
	/*...Block 8: t0E,t1E,t2E,t3E	*/
		...
		fprintf(stderr, "radix32_dyadic_square: a1p00 = %20.5f, %20.5f\n",r00->re,r01->re);
		fprintf(stderr, "radix32_dyadic_square: a1p01 = %20.5f, %20.5f\n",r20->re,r21->re);
		fprintf(stderr, "radix32_dyadic_square: a1p02 = %20.5f, %20.5f\n",r10->re,r11->re);
		fprintf(stderr, "radix32_dyadic_square: a1p03 = %20.5f, %20.5f\n",r30->re,r31->re);
		fprintf(stderr, "radix32_dyadic_square: a1p04 = %20.5f, %20.5f\n",r08->re,r09->re);
		fprintf(stderr, "radix32_dyadic_square: a1p05 = %20.5f, %20.5f\n",r28->re,r29->re);
		fprintf(stderr, "radix32_dyadic_square: a1p06 = %20.5f, %20.5f\n",r18->re,r19->re);
		fprintf(stderr, "radix32_dyadic_square: a1p07 = %20.5f, %20.5f\n",r38->re,r39->re);
		fprintf(stderr, "radix32_dyadic_square: a1p08 = %20.5f, %20.5f\n",r04->re,r05->re);
		fprintf(stderr, "radix32_dyadic_square: a1p09 = %20.5f, %20.5f\n",r24->re,r25->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0A = %20.5f, %20.5f\n",r14->re,r15->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0B = %20.5f, %20.5f\n",r34->re,r35->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0C = %20.5f, %20.5f\n",r0C->re,r0D->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0D = %20.5f, %20.5f\n",r2C->re,r2D->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0E = %20.5f, %20.5f\n",r1C->re,r1D->re);
		fprintf(stderr, "radix32_dyadic_square: a1p0F = %20.5f, %20.5f\n",r3C->re,r3D->re);
		fprintf(stderr, "radix32_dyadic_square: a1p10 = %20.5f, %20.5f\n",r02->re,r03->re);
		fprintf(stderr, "radix32_dyadic_square: a1p11 = %20.5f, %20.5f\n",r22->re,r23->re);
		fprintf(stderr, "radix32_dyadic_square: a1p12 = %20.5f, %20.5f\n",r12->re,r13->re);
		fprintf(stderr, "radix32_dyadic_square: a1p13 = %20.5f, %20.5f\n",r32->re,r33->re);
		fprintf(stderr, "radix32_dyadic_square: a1p14 = %20.5f, %20.5f\n",r0A->re,r0B->re);
		fprintf(stderr, "radix32_dyadic_square: a1p15 = %20.5f, %20.5f\n",r2A->re,r2B->re);
		fprintf(stderr, "radix32_dyadic_square: a1p16 = %20.5f, %20.5f\n",r1A->re,r1B->re);
		fprintf(stderr, "radix32_dyadic_square: a1p17 = %20.5f, %20.5f\n",r3A->re,r3B->re);
		fprintf(stderr, "radix32_dyadic_square: a1p18 = %20.5f, %20.5f\n",r06->re,r07->re);
		fprintf(stderr, "radix32_dyadic_square: a1p19 = %20.5f, %20.5f\n",r26->re,r27->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1A = %20.5f, %20.5f\n",r16->re,r17->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1B = %20.5f, %20.5f\n",r36->re,r37->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1C = %20.5f, %20.5f\n",r0E->re,r0F->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1D = %20.5f, %20.5f\n",r2E->re,r2F->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1E = %20.5f, %20.5f\n",r1E->re,r1F->re);
		fprintf(stderr, "radix32_dyadic_square: a1p1F = %20.5f, %20.5f\n",r3E->re,r3F->re);
		fprintf(stderr, "Outputs B:\n");
		fprintf(stderr, "radix32_dyadic_square: a1p00 = %20.5f, %20.5f\n",r00->im,r01->im);
		fprintf(stderr, "radix32_dyadic_square: a1p01 = %20.5f, %20.5f\n",r20->im,r21->im);
		fprintf(stderr, "radix32_dyadic_square: a1p02 = %20.5f, %20.5f\n",r10->im,r11->im);
		...
		__asm__ volatile (\
			...
			:					// outputs: none
			: [__r00] "m" (r00)	// All inputs from memory addresses here
			: "rax","xmm0","xmm1","xmm2","xmm3","xmm4","xmm5"	// Clobbered registers
		);
