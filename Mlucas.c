...
!
!   This version (14.1) dated 11 Dec 2014.
!
...
!
!   See http://hogranch.com/mayer/README.html for build instructions, recent revision history of the code
!   and a summary of what has been changed/added/deleted in the latest release.
!
!***TO DO LIST:
!
!   Performance-related:
...
int 	main(int argc, char *argv[])
{
	...
	*/
	...
	/*	    -----    --------     ----------------     -----------     -----------         ----------------     -----------     -----------    */
		...
		{ 20480, 374233309u, { {0x6D95C0E62C8F9606ull,  3426866174ull, 39787406588ull}, {0xD08FB9031D460B7Eull, 30083048700ull, 30636357797ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 22528, 410766953u, { {0x254572CAB2014E6Cull, 17794160487ull, 13396317974ull}, {0x6202B11AA8602531ull,  9896689730ull, 13179771096ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 24576, 447223969u, { {0x547DF462C7DAD1F6ull, 21523243373ull, 60663902864ull}, {0x06AB4D8E6FD9D69Bull, 23751736171ull, 10720018557ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 26624, 483610763u, { {0xED3E248A29A1C6A8ull,  3863520901ull, 56560420765ull}, {0xC29358F8206746D6ull, 28829535828ull,  8160695393ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 28672, 519932827u, { {0xCA7B3A76819D67F7ull,  7078504016ull, 32836389262ull}, {0x5799C8BE8E02B56Full, 22269194969ull, 11617462155ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 30720, 556194803u, { {0x56CDF80EFF67C1C1ull, 15611746359ull, 45837150207ull}, {0xCBC88456B4B47AC0ull,  3535843471ull, 18652930008ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 32768, 592400713u, { {0xD8C829884B234EB4ull, 13278383896ull, 54835531046ull}, {0x994DD6B24F452451ull, 28289805997ull, 11462134131ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 36864, 664658101u, { {0x2A809B0C735BAC4Bull, 10513414423ull, 54347266174ull}, {0xAB2147D9BAA22BB4ull, 12259954326ull, 67125404781ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 40960, 736728527u, { {0xB9AC3EC848FF60A5ull,  7352037613ull,  7261166574ull}, {0x3D623A79D0F14EFFull, 31246254654ull, 49195074754ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 45056, 808631029u, { {0x9D543D67F48AF766ull,  4288733345ull, 27338399854ull}, {0x62A4DF80612E897Bull, 32232536296ull, 47296762118ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 49152, 880380937u, { {0x82ED59E22D585BF6ull, 34028441473ull, 54282489944ull}, {0x7F110FD687DB7CB5ull, 14440703450ull, 57885720403ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 53248, 951990961u, { {0xE98B9D69E5F350D1ull, 14692034938ull,  2987127112ull}, {0x634157BCC596287Dull, 31799414844ull, 64590776355ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 57344,1023472049u, { {0x960CE3D7029BDB70ull, 30108539760ull,  2075307892ull}, {0x9D98FF9A3FD21D1Bull, 10507186734ull,  3891581073ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		{ 61440,1094833457u, { {0x9A2592E96BC1C827ull, 40462567463ull, 18678252759ull}, {0x79BF2E2F5AE7985Bull,  8407199527ull, 64114889744ull}, {0x0000000000000000ull,           0ull,           0ull} } },
		/* Huge: */
